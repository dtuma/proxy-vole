...
/*****************************************************************************
 * Test program submitted to test the issue 27 with PAC proxy selector that is while downloading the PAC file invoking
 * itself. This has lead to a endless loop. The issue is now solved but I keep this test program for future PAC testing.
 * 
    ...
    private void installLogger() {
        Logger.setBackend(new Logger.LogBackEnd() {
            ...
            public void log(Class<?> clazz, LogLevel loglevel, String msg, Object... params) {
                System.out.println(loglevel + "\t" + MessageFormatter.format(msg, params));
            }
